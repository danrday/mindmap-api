defmodule PlanatlasWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Planatlas.MyChannel do
        use PlanatlasWeb, :channel
        alias PlanatlasWeb.Presence
  ...
  def fetch(_topic, entries) do
    users =
      entries
      |> Map.keys()
      |> Planatlas.Accounts.list_users_with_ids()
      |> Enum.into(%{}, fn user -> 
  ...
  use Phoenix.Presence, otp_app: :planatlas,
                        pubsub_server: Planatlas.PubSub
end
